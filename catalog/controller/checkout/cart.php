		...
		if ($product_info) {
			...
			foreach ($product_options as $product_option) {
                ...
                if(!empty($option[$product_option['product_option_id']])) {
                    foreach ($product_option['product_option_value'] as $temp_value) {
                        if ($temp_value['product_option_value_id'] == $option[$product_option['product_option_id']]) {
                            $product_option_value = $temp_value;
                        }
                    }
                }
			}
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'] . '[' . $product_option_value['option_value'] . ']', $this->url->link('checkout/cart'));
