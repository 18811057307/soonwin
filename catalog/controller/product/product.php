	...
	public function index() {
		...
		if ($product_info) {
			...
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
                ...
                $data['price'] = number_format($product_info['price'],$this->currency->getDecimalPlace());
			} else {
				$data['price'] = false;
			}
				...
				foreach ($option['product_option_value'] as $option_value) {
					if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
						...
						$product_option_value_data[] = array(
                            ...
                            'image_large'                   => $this->model_tool_image->resize($option_value['image'], 225, 225),
							'price'                   => number_format($option_value['price'],$this->currency->getDecimalPlace()),
