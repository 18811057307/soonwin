...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $data['bp'] = $this->url->link('information/bp');
        ...
        if($this->customer->isLogged()) {
            ...
            if (!empty($customer_info)) {
                ...
                $data['credit'] = $this->currency->format($customer_info['credit']);
                $data['availablecredit'] = $this->currency->format($customer_info['credit'] + $this->customer->getBalance());
            }
        }
