...
<nav id="top">
  <div class="container">
    ...
    <div id="top-links" class="nav pull-left">
        ...
        <?php if ($logged) { ?>
        <li><a href="<?php echo $transaction; ?>"><span class="hidden-xs hidden-sm hidden-md"><?php echo $firstname; ?>（当前可用额度<?php echo $availablecredit; ?>,信贷额度<?php echo $credit; ?>）</span></a></li>
