...
class ModelCatalogProduct extends Model {
		...
		if (!empty($data['filter_category_id'])) {
			...
			if (!empty($data['filter_filter'])) {
				...
				foreach ($filters as $filter_id) {
                    ...
                    $sql .= " AND pf.filter_id LIKE '%" . $filter_id  . "%'";
				}
	...
	public function getProductOptions($product_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			$product_option_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option_value pov RIGHT JOIN " . DB_PREFIX . "option_description od ON (od.option_id = pov.option_id)  WHERE pov.product_id = '" . (int)$product_id . "' AND pov.product_option_id = '" . (int)$product_option['product_option_id'] . "' AND od.language_id = '" . (int)$this->config->get('config_language_id') . "'");
