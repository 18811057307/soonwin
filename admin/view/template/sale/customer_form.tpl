                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" name="credit" value="<?php echo $credit; ?>" placeholder="<?php echo $entry_fax; ?>" id="input-credit" class="form-control" />
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select name="over_credit_status_id" id="input-order-status" class="form-control">
                                  <?php foreach ($order_statuses as $order_status) { ?>
                                  <?php if ($order_status['order_status_id'] == $over_credit_status_id) { ?>
