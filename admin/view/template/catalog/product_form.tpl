                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value]" value="<?php echo $product_option_value['option_value']; ?>" placeholder="<?php echo $entry_option_value; ?>" class="form-control" /></td>
                              <td class="text-left"><a href="" id="thumb-image<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_option_value['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][image]" value="<?php echo $product_option_value['image']; ?>" id="input-image<?php echo $option_value_row; ?>" /></td>
            ...
            <div class="tab-pane" id="tab-discount">
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left" width="15%"><?php echo $entry_customer_group; ?></td>
                      <td class="text-right" width="15%"><?php echo $entry_quantity; ?></td>
                      <td class="text-right" width="15%"><?php echo $entry_priority; ?></td>
                      <td class="text-right" width="15%"><?php echo $entry_price; ?></td>
                      <td class="text-left" width="20%"><?php echo $entry_date_start; ?></td>
                      <td class="text-left" width="20%"><?php echo $entry_date_end; ?></td>
                      <td></td>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div class="tab-pane" id="tab-special">
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left" width="20%"><?php echo $entry_customer_group; ?></td>
                      <td class="text-right" width="20%"><?php echo $entry_priority; ?></td>
                      <td class="text-right" width="20%"><?php echo $entry_price; ?></td>
                      <td class="text-left" width="20%"><?php echo $entry_date_start; ?></td>
                      <td class="text-left" width="20%"><?php echo $entry_date_end; ?></td>
                      <td></td>
                    </tr>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image-pi<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="input-image-pi<?php echo $image_row; ?>" /></td>
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
            ...
            html += '        <td class="text-left"><?php echo $entry_image; ?></td>';
...
function addOptionValue(option_row) {	
    ...
    html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value]" value="" placeholder="<?php echo $entry_option_value; ?>" class="form-control" /></td>';
    html += '  <td class="text-right"><a href="" id="thumb-image' + option_value_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][image]" value="" id="input-image' + option_value_row + '" /></td>';
