      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="parent_filter_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($parent_filter_description['filter_description'][$language['language_id']]) ? $parent_filter_description['filter_description'][$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_group; ?>" class="form-control" />
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sort_order" value="<?php echo isset($parent_filter_description['sort_order']) ? $parent_filter_description['sort_order'] : '';; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
            ...
            <tbody>
              ...
              <tr id="filter-row<?php echo $filter_row; ?>">
                <td class="text-left" style="width: 50%;">
                  ...
                  <input type="hidden" name="filter[<?php echo $filter_row; ?>][parent_filter_id]" value="<?php echo $filter['parent_filter_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                  ...
                  <?php } ?>
                  <?php } ?></td>
              <td class="text-left"><a href="" id="thumb-image<?php echo $filter_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $filter['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="filter[<?php echo $filter_row; ?>][image]" value="<?php echo $filter['image']; ?>" id="input-image<?php echo $filter_row; ?>" /></td>
              <td class="text-right"><input type="text" name="filter[<?php echo $filter_row; ?>][sort_order]" value="<?php echo $filter['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" /></td>
                <td class="text-left">
                    <button type="button" onclick="$('#filter-row<?php echo $filter_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                </td>
              </tr>
              <?php $filter_row++; ?>
              <?php } ?>
...
function addFilterRow() {
    ...
    html += '<input type="hidden" name="filter[' + filter_row + '][parent_filter_id]" value="" />';
	<?php foreach ($languages as $language) { ?>
	...
	<?php } ?>
	html += '  </td>';
    html += '  <td class="text-left"><a href="" id="thumb-image' + filter_row + '" data-toggle="image" class="img-thumbnail"><img src="" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="filter[' + filter_row + '][image]" value="" id="input-image' + filter_row + '" /></td>';
