...
class ModelSaleCustomer extends Model {
	...
	public function getTotalCustomerRewardsByOrderId($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_reward WHERE points > 0 AND order_id = '" . (int)$order_id . "'");
